...
export function HeroSection({ siteName, tagline, ctaHref, ctaLabel }: HeroSectionProps) {
  return (
    <section className="relative overflow-hidden rounded-3xl bg-gradient-to-b from-sky-100 via-sky-50 to-amber-50 p-10 shadow-sm ring-1 ring-sky-100 sm:p-14">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute bottom-10 left-1/3 h-24 w-24 rounded-full bg-amber-100/60 blur-2xl" />
      </div>
      <div className="relative grid gap-5">
        <p className="text-sm font-medium uppercase tracking-[0.22em] text-sky-700">Welcome</p>
